...
<head>
    ...
    <title>Ideathrone</title>
    <link rel="stylesheet" href="ideathrone.css">
...
<nav class="navbar navbar-expand-lg bg-body-black">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="h1 text-white text-center mt-5">Ideathrone</div>
            </div>
                        ...
                        <div class="click-section">
                            <div class="evt-descp h4 text-center text-white">EVENT DESCRIPTION</div>
                                <div class="descp" style="display:none;">
                                    Bolster your Brilliance in Infinity 2k24's Ideathrone !<br><br>
                                    Dive into the innovation pool - where ideas flow freely and brilliance takes the
                                    center stage!<br><br>
                                    Team up as two to undertake the challenge of dissecting a problem statement
                                    and leveraging the intellectual acuity to
                                    fashion a well-crafted solution.<br><br>
                                    But that's just the warm up, don't stop with this…<br><br>
                                    Ignite your imagination to beat the odds and become a part of a celebration.<br><br>
                                    So, are you ready to step into the spotlight?<br><br>
                                    Warm up for a majestic showdown of wits and innovation.<br><br>
                                    To all the critical thinkers, dreamers and solution architects in the digital
                                    spectrum. Don't miss out on the excitement!<br><br>
                                </div>
                        </div>
                        <div class="click-section">
                            <div class="r_r h4 text-center text-white">RULES & REGULATIONS</div>
                                <div class="r_r_desp bg-white" style="display:none;">
                                    <b>DO's:</b><br><br>
                                    A scenario based question will be asked in Google forms to be filled
                                    by the players.<br><br>
                                    Players can pair up into 2 as a team.<br><br>
                                    Players should come up with an detailed presentation for about 10-15
                                    minutes in the second round<br><br>
                                    Players should also give the solution along with the idea.<br><br>
                                    The first team to complete this is rewarded.<br><br>
                                    <b>DON'Ts:</b><br><br>
                                    Players should not get distracted and lose time while filling the
                                    Google forms.<br><br>
                ...
                <div class="contact">
                    <div class="row">
                        ...
                        <div class="col-6 bod-right">
                            <p class="text-white d-flex justify-content-center cont-quote1">APOORVA</p>
                            <p class="text-white d-flex justify-content-center cont-quote2">9400619811</p>
                        </div>

                        <div class="col-6">
                            <p class="text-white d-flex justify-content-center cont-quote1">SWETHA</p>
                            <p class="text-white d-flex justify-content-center cont-quote2">7010176089</p>
                        </div>
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if (!isset($_SESSION['userid'])) {
        ...
        $query_already="select * from ideathrone where studentone='".$_SESSION['userid']."'";
        ...
        $query="select * from ideathrone where studenttwo='".$_SESSION['userid']."'";
        ...
        $query_two="select * from ideathrone where studenttwo='$student_two'";
        ...
        $query_two="select * from ideathrone where studentone='$student_two'";
        $query_two_run=mysqli_query($conn,$query_two);
        if(mysqli_fetch_row($query_two_run)>0){
            echo "<script>
            swal({
        ...
        while($row = mysqli_fetch_assoc($query_run)){
            ...
            $insert_check="insert into ideathrone values('$student_one_check','$student_id_two');";
            $insert_run=mysqli_query($conn,$insert_check);
            $ch = curl_init('https://script.google.com/macros/s/AKfycbzaD2dmAUyeAglVQa7vwXzkpW4X4_F_nLzeOvhIt0w16e_2Pwa6oNs6O4VyCEBHIoWukg/exec');
