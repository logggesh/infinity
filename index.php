...
<nav class="navbar navbar-expand-lg bg-body-black">
  ...
  <a class="navbar-brand text-white ms-3" href="#">
      <img src="logo/logo.png" alt="Bootstrap" class="ms-3" width="45" height="50">
      &nbsp&nbspPSG COLLEGE OF TECHNOLOGY
    </a>
  ...
  <div class="row">
    ...
    <div class="col-lg-12 d-flex justify-content-center align-items-center mt-5">
      <div class="abt-us-cont">
        <div class="row">
          <div class="col-lg-6">
          <div class="abt-us-disp justify-content-center d-flex align-items-center">
            <lottie-player src="https://lottie.host/0803472b-88c4-446b-892d-83752ffb5e3d/jRiM1ZXCfX.json" background="##FFFFFF" speed="1" style="width: 500px; height: 500px" loop autoplay direction="1" mode="normal"></lottie-player>
          </div>
          </div>
